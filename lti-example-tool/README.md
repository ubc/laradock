Modified for easier inclusion into Laradock.

Original project: [https://github.com/IMSGlobal/lti-1-3-php-example-tool](https://github.com/IMSGlobal/lti-1-3-php-example-tool)
